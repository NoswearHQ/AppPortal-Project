...
public class WSPREVOUTModel {
	...
	public String toString() {
		return "WSBILLSModel [company=" + company + ", password=" + password + ", userName=" + userName
	...
	public void setCriteriaValue4(String criteriaValue4) {
		CriteriaValue4 = criteriaValue4;
	}
	public String getOperand4() {
		return operand4;
	}
	public void setOperand4(String operand4) {
